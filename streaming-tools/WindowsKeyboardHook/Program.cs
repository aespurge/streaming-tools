namespace WindowsKeyboardHook {
    ...
    internal class Program {
        ...
        private static int KeystrokeCallback(int nCode, IntPtr wParam, IntPtr lParam) {
            ...
            return User32.CallNextHookEx(hook.DangerousGetHandle(), nCode, wParam, lParam);
        }
        ...
        private static void Main(string[] args) {
            ...
            // Set a hook.
            hook = User32.SetWindowsHookEx(User32.WindowsHookType.WH_KEYBOARD_LL, KeystrokeCallback, IntPtr.Zero, 0);
